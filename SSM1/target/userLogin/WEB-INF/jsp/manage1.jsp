        ...
        <div class="row fullscreen d-flex align-items-center justify-content-center">
            <div class="banner-content col-lg-8 col-md-12">
                ...
                <div class="input-wrap">
                    <form action="/selectCourse" class="form-box d-flex justify-content-between">
                        <input type="text" placeholder="Search Course" class="form-control" id="course_id"name="course_id">
