...
<div class="demos">
    <ul>
        <li><a href="/manage2">学生选课查询</a></li>
        <li><a href="/add2">学生选课</a></li>
...
<div >
    <center>
        <table border="1" cellpadding="10" cellspacing="0" class="table1" bgcolor="#2ba3d4">
            ...
            <c:forEach items="${requestScope.pagemsg.lists}" var="scourse" varStatus="status">
                <tr>
                    <!-- 和po类里的属性名一样 -->
       ...
       <c:if test="${requestScope.pagemsg.currPage != 1}">
           <a href="${pageContext.request.contextPath }/scourse?currentPage=1">[首页]</a>&nbsp;&nbsp;
           <a href="${pageContext.request.contextPath }/scourse?currentPage=${requestScope.pagemsg.currPage-1}">[上一页]</a>&nbsp;&nbsp;
       </c:if>

       <c:if test="${requestScope.pagemsg.currPage != requestScope.pagemsg.totalPage}">
           <a href="${pageContext.request.contextPath }/scourse?currentPage=${requestScope.pagemsg.currPage+1}">[下一页]</a>&nbsp;&nbsp;
           <a href="${pageContext.request.contextPath }/scourse?currentPage=${requestScope.pagemsg.totalPage}">[尾页]</a>&nbsp;&nbsp;
       </c:if>
   </span>
                </td>
            </tr>
