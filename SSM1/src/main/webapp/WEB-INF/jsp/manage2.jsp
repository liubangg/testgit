        ...
        <div class="row align-items-center justify-content-between d-flex">
            ...
            <nav id="nav-menu-container">
                <ul class="nav-menu">
                    ...
                    <li class="menu-has-children"><a href="/manage">学生信息查询</a></li>
        ...
        <div class="row fullscreen d-flex align-items-center justify-content-center">
            <div class="banner-content col-lg-8 col-md-12">
                ...
                <div class="input-wrap">
                    <form action="/selectSCourse" class="form-box d-flex justify-content-between">
                        <input type="text" placeholder="Search Course" class="form-control" id="student_id"name="student_id">
